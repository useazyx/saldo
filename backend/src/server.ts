 ...
 * - v1.1.0 (2026-09-11): Mostra o endereço da documentação
 */

import { buildApp, DOCS_ROUTE } from "./app.js"
...
async function start() {
  ...
  try {
    ...
    console.log(`📚 Documentação em http://localhost:${env.PORT}${DOCS_ROUTE}`)
  } catch (error) {
